<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyList.aspx.cs" Inherits="Wuyiju.Web.Question.MyList" MasterPageFile="~/Site.Master" %>
        ...
        <div class="main_content2">
            ...
            <div class="tab_box">
                <ul class="tabNavigation">
                    <li><a id="isg1" href="/question/" style="cursor: pointer;" class="ti1" >网友正在提问</a></li>
                    <li><a id="isg2" href="/question/MyList.aspx" style="cursor: pointer;" class="ti2">我的提问</a></li>
                </ul>
                <div id="first">
