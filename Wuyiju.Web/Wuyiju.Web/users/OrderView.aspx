<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderView.aspx.cs" Inherits="Wuyiju.Web.users.OrderView" MasterPageFile="~/users/UserCenter.Master" %>
    ...
    <div class="con-manageCenter glzx" style="padding-bottom: 30px;">
        ...
        <div class="shop-news">
            ...
            <dl class="clearfix">
                ...
                <dd class="xhz"><%=Order.Fee %> 元<font color="#FF6600">(手续费为成交价格的<%=ApplicationConfig.SysFeeLabel %>，手续费折扣：无)</font></dd>
            </dl>
            <p></p>
            <dl class="clearfix">
                <dt class="wyfb">消保保证金： </dt>
                <dd class="xhz"><%=Order.Ensure %> 元</dd>
            </dl>
            <p></p>
            <dl class="clearfix">
                <dt class="wyfb">(退还)技术年费： </dt>
                <dd class="xhz"><%=Order.Techfee %> 元</dd>
            </dl>
            <p></p>
            <dl class="clearfix">
                <dt class="wyfb">订单总额： </dt>
                <dd class="xhz"><strong class="red"><%=Order.Total_Fee %></strong> 元</dd>
            </dl>
            <p></p>
            ...
            <form id="ipayform" action="/Users/PayHandle.aspx" onsubmit="return payPwdCheck();" method="post">
                ...
                <div id="payall" style="display: block;">
                    ...
                    <dl class="clearfix">
                        ...
                        <dd class="xhz">
                            <input type="button" name="payed_money" id="payed_money" value="<%=Order.Total_Fee %>" style="color: red; background-color: #fff; font-weight: bold;">
                            元</dd>
                    </dl>
                    <p></p>
                ...
                <div id="paypart" style="display: none;">
                    <dl class="clearfix">
                        <dt class="wyfb">支付总额： </dt>
                        <dd class="xhz"><strong class="red" id="iallmon"><%=Order.Deposit %></strong> 元</dd>
                    </dl>
                    <p></p>
                ...
                <dl class="clearfix" style="line-height: 30px;">
                    <dt class="wyfb">付款方式： </dt>
                    <dd class="xhz" style="height: auto;">
                        <span class="fukuanfangshi">余款支付</span>
                    </dd>
                </dl>
                <p></p>
                <div id="payothers" style="display: block;">

                    <dl class="clearfix">
                        <dt class="wyfb">余款金额： </dt>
                        <dd class="xhz">
                            <input type="button" name="payed_money" id="payed_money" value="<%=Order.Total_Fee - Order.Pay_Fee %>" style="color: red; background-color: #fff; font-weight: bold;">
                            元</dd>
                    </dl>
                    <p></p>
                    <dl class="clearfix" id="idjtshow" style="display: none">
                ...
                <dl class="clearfix">
                    ...
                    <dd class="xhz">
                        <input type="password" name="pwd" id="consigneePayPwd" class="txt-style1" style="height: 27px; margin-top: 9px; width: 200px; line-height: 27px\9;">&nbsp;&nbsp;
			          	<a href="/Users/ForgetPayPwd.aspx" style="color: #008000; text-decoration: underline;">忘记支付密码？</a>&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="/Detail.aspx?id=62" style="color: #279FF0; text-decoration: underline;">选猫网责任与义务相关声明</a></dd>
                </dl>
                <dl class="clearfix">
