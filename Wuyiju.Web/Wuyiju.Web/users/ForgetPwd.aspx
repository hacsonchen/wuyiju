<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ForgetPwd.aspx.cs" Inherits="Wuyiju.Web.users.ForgetPwd" %>
...
<body>
    <div class="register-wrap">
        ...
        <div class="register-form">
            ...
            <form id="iform1" name="regform1" action="ForgetPwd.aspx" method="post">
                <div class="valid-msg">
