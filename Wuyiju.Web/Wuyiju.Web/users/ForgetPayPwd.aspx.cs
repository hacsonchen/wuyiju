...
{
    public partial class ForgetPayPwd : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if ("POST".Equals(Request.RequestType.ToUpper()))
            {
                ...
                user.Pay_Password = Request.Form["pwd"];
                ...
                try
                {
                    ...
                    if (user.Mobile.IsNullOrWhiteSpace() || user.Pay_Password.IsNullOrWhiteSpace())
                    ...
                    userSvr.ForgetPayPassword(user.Mobile, user.Pay_Password);
