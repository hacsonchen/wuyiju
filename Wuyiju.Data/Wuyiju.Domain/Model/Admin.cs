    ...
    public class Admin
    {
        ...
        public DateTime? PreLoginTime
        {
            get
            {
                try
                {
                    return _pre_login_time.ToDateTime();
                }
                catch
                {
                    return null;
        ...
        /// pre_login_ip
        /// </summary>		
        private string _pre_login_ip;
        public string Pre_Login_Ip
        {
        ...
        public string PreLoginIp
        {
            get
            {
                try
                {
                    return System.Net.IPAddress.Parse(_pre_login_ip).ToString();
                }
                catch
                {
                    return "";
