...
namespace Wuyiju.Service {
	 	//ec_message
		public class MessageService: BaseService<IMessageDAL>, IMessageService
	{
		...
		/// 更新一条数据
		/// </summary>
		public void Modify(Wuyiju.Model.Message obj)
        {
            if (obj == null)
                throw new ApplicationException("参数不能为空");
		...
		/// 获得数据列表
		/// </summary>
		public IList<Wuyiju.Model.Message> GetList(Wuyiju.Model.Message.Query query)
        {
		...
		/// 获得前几行数据
		/// </summary>
		public IList<Wuyiju.Model.Message> GetList(Wuyiju.Model.Message.Query query, int? limit = null)
        {
