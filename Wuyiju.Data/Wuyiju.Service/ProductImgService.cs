...
namespace Wuyiju.Service {
	 	//ec_product_img
		public class ProductImgService: BaseService<IProductImgDAL>, IProductImgService
	{
		...
		/// 更新一条数据
		/// </summary>
		public void Modify(Wuyiju.Model.ProductImg obj)
        {
            if (obj == null)
                throw new ApplicationException("参数不能为空");
		...
		/// 获得数据列表
		/// </summary>
		public IList<Wuyiju.Model.ProductImg> GetList(Wuyiju.Model.ProductImg.Query query)
        {
		...
		/// 获得前几行数据
		/// </summary>
		public IList<Wuyiju.Model.ProductImg> GetList(Wuyiju.Model.ProductImg.Query query, int? limit = null)
        {
