...
namespace Wuyiju.Service {
	 	//ec_enroll
		public class EnrollService: BaseService<IEnrollDAL>, IEnrollService
	{
		...
		/// 更新一条数据
		/// </summary>
		public void Modify(Wuyiju.Model.Enroll obj)
        {
            if (obj == null)
                throw new ApplicationException("参数不能为空");
		...
		/// 获得数据列表
		/// </summary>
		public IList<Wuyiju.Model.Enroll> GetList(Wuyiju.Model.Enroll.Query query)
        {
		...
		/// 获得前几行数据
		/// </summary>
		public IList<Wuyiju.Model.Enroll> GetList(Wuyiju.Model.Enroll.Query query, int? limit = null)
        {
