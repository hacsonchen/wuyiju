...
namespace Wuyiju.IDAL {
	...
	/// 接口层AdminScoresCopy
	/// </summary>
	public interface IAdminScoresCopyDAL
	{
		#region  成员方法
		/// <summary>
		/// 增加一条数据
		/// </summary>
		void Insert(Wuyiju.Model.AdminScoresCopy model);
		
		/// <summary>
		/// 更新一条数据
		/// </summary>
		void Update(Wuyiju.Model.AdminScoresCopy model);
		...
		/// 得到一个对象实体
		/// </summary>
		Wuyiju.Model.AdminScoresCopy Get(int id);
		/// <summary>
		/// 获得数据列表
		/// </summary>
