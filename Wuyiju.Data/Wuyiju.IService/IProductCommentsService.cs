...
namespace Wuyiju.IService {
	...
	public interface IProductCommentsService
	{
		...
		/// 增加一条数据
		/// </summary>
		void Add(Wuyiju.Model.ProductComments obj);
		
		/// <summary>
		/// 更新一条数据
		/// </summary>
		void Modify(Wuyiju.Model.ProductComments obj);
		
		/// <summary>
		/// 删除数据
		/// </summary>
		void Remove(Wuyiju.Model.ProductComments obj);

		/// <summary>
		/// 得到一个对象实体
		/// </summary>
		Wuyiju.Model.ProductComments GetProductComments(int id);
		/// <summary>
		/// 获得数据列表
		/// </summary>
