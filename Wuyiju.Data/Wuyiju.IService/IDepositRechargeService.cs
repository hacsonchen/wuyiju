...
namespace Wuyiju.IService {
	...
	/// 接口层DepositRecharge
	/// </summary>
	public interface IDepositRechargeService
	{
		#region  成员方法
		/// <summary>
		/// 增加一条数据
		/// </summary>
		void Add(Wuyiju.Model.DepositRecharge obj);
		
		/// <summary>
		/// 更新一条数据
		/// </summary>
		void Modify(Wuyiju.Model.DepositRecharge obj);
		
		/// <summary>
		/// 删除数据
		/// </summary>
		void Remove(Wuyiju.Model.DepositRecharge obj);

		/// <summary>
		/// 得到一个对象实体
		/// </summary>
		Wuyiju.Model.DepositRecharge GetDepositRecharge(int id);
		/// <summary>
		/// 获得数据列表
		/// </summary>
        ...
        void Recharge(Wuyiju.Model.DepositRecharge obj);
