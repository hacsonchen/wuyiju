...
namespace Wuyiju.IService {
	...
	public interface IAdPositionService
	{
		...
		/// 增加一条数据
		/// </summary>
		void Add(Wuyiju.Model.AdPosition obj);
		
		/// <summary>
		/// 更新一条数据
		/// </summary>
		void Modify(Wuyiju.Model.AdPosition obj);
		
		/// <summary>
		/// 删除数据
		/// </summary>
		void Remove(Wuyiju.Model.AdPosition obj);

		/// <summary>
		/// 得到一个对象实体
		/// </summary>
		Wuyiju.Model.AdPosition GetAdPosition(int id);
		/// <summary>
		/// 获得数据列表
		/// </summary>
