...
namespace Wuyiju.IService {
	...
	/// 接口层AskReply
	/// </summary>
	public interface IAskReplyService
	{
		#region  成员方法
		/// <summary>
		/// 增加一条数据
		/// </summary>
		void Add(Wuyiju.Model.AskReply obj);
		
		/// <summary>
		/// 更新一条数据
		/// </summary>
		void Modify(Wuyiju.Model.AskReply obj);
		
		/// <summary>
		/// 删除数据
		/// </summary>
		void Remove(Wuyiju.Model.AskReply obj);

		/// <summary>
		/// 得到一个对象实体
		/// </summary>
		Wuyiju.Model.AskReply GetAskReply(int id);
		/// <summary>
		/// 获得数据列表
		/// </summary>
