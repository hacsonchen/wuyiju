...
namespace Wuyiju.IService {
	...
	/// 接口层ArticleCopy
	/// </summary>
	public interface IArticleCopyService
	{
		#region  成员方法
		/// <summary>
		/// 增加一条数据
		/// </summary>
		void Add(Wuyiju.Model.ArticleCopy obj);
		
		/// <summary>
		/// 更新一条数据
		/// </summary>
		void Modify(Wuyiju.Model.ArticleCopy obj);
		
		/// <summary>
		/// 删除数据
		/// </summary>
		void Remove(Wuyiju.Model.ArticleCopy obj);

		/// <summary>
		/// 得到一个对象实体
		/// </summary>
		Wuyiju.Model.ArticleCopy GetArticleCopy(int id);
		/// <summary>
		/// 获得数据列表
		/// </summary>
