...
namespace Wuyiju.IService {
	...
	public interface IFavoritesService
	{
		...
		/// 增加一条数据
		/// </summary>
		void Add(Wuyiju.Model.Favorites obj);
		
		/// <summary>
		/// 更新一条数据
		/// </summary>
		void Modify(Wuyiju.Model.Favorites obj);
		
		/// <summary>
		/// 删除数据
		/// </summary>
		void Remove(Wuyiju.Model.Favorites obj);

		/// <summary>
		/// 得到一个对象实体
		/// </summary>
		Wuyiju.Model.Favorites GetFavorites(int rec_id);
		/// <summary>
		/// 获得数据列表
		/// </summary>
